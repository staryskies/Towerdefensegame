const towerStats = {
  ...
  laser: { damage: 20, range: 150, fireRate: 10000, unlockCost: 300, persistentCost: 1200, color: "red", ability: "Continuous beam every 10s", unlocked: false },
  ...
  missile: { damage: 60, range: 140, fireRate: 2000, unlockCost: 220, persistentCost: 880, color: "silver", ability: "High damage", unlocked: false },
  poison: { damage: 10, range: 160, fireRate: 2000, unlockCost: 200, persistentCost: 800, color: "limegreen", ability: "Poison splash", unlocked: false },
  vortex: { damage: 0, range: 150, fireRate: 5000, unlockCost: 350, persistentCost: 1400, color: "purple", ability: "Pulls enemies back every 5s", unlocked: false },
};